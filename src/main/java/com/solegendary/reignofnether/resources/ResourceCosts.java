...
public class ResourceCosts {
    ...
    public static ResourceCost RESEARCH_RESOURCE_CAPACITY = ResourceCost.Research(0,150,50, 90);
    ...
    public static ResourceCost RESEARCH_COLLECTION_EFFICIENCY = ResourceCost.Research(250,250,300,60);
}
